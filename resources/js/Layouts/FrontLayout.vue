    ...
    <div>
                    ...
                    <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                        <nav>
                            <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                                <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" :href="route('front.products.list')">Products</a></li>
                            </ul>
                        </nav>
                    </div>
        ...
        <section class="bg-white py-8">
            ...
            <div class="container py-8 px-6 mx-auto">
                ...
                <p class="mt-8 mb-8">This template is inspired by the stunning nordic minamalist design - in particular:</p>
                    <br>
